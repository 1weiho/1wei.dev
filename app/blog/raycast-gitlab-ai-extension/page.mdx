...
If you want to see my implementation in full, check it out here: [PR - Provide AI extension support for GitLab extension](https://github.com/raycast/extensions/pull/21670)
